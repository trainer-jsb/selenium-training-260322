...
public class DatePicker {
	...
	public void testMethod() {
		...
		Reporter.log("Click on calendar icon");
		driver.findElement(By.cssSelector("div.input-group.date>span.input-group-addon")).click();
		
		Reporter.log("Get the list of days of the week");
		List<WebElement> dow = driver.findElements(By.className("dow"));
		
		Reporter.log("Assert there are 7 days in a week");
		sf.assertEquals(dow.size(), 7);
		
		Reporter.log("Assert that first day of the week should be Monday");
		...
		Reporter.log("Created list of days from UI");
		
		//Compare days in the actual list with the expected list
